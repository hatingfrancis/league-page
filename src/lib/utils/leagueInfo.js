/*   STEP 1   */
export const leagueID = "784483596315582464"; // your league ID
export const leagueName = "The KSO League"; // your league name
...
export const homepageText = `
  <p>The KSO League is a 16 team dynasty league made up of fans and alumni of Kansas State University.</p>
<p/> The league was formed in 2018 </p>
`;
...
export const managers = [
    {
      ...
      "location": "Manhattan Kansas", // (optional)
      "bio": "Lorem ipsum...",
      "photo": "/managers/psycho.jpg", // square ratio recommended (no larger than 500x500)
      ...
      "rival": {
        ...
        image: "/managers/elway.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
      },
